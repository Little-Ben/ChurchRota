...
<div class="elementBackground">
		...
		<?php 
			if ($debug) {
				...
				echo "<tbody>";
					...
					$sql = "SELECT detail3 as browser, count(*) as count from cr_statistics where detail1 like 'login%' group by detail3 order by count desc ".$browserLimit;
		...
		<a href="#" data-reveal-id="truncStatData" class="button">Delete Statistics</a>

			<div id="truncStatData" class="reveal-modal">
     			<h1>Really delete all statistics?</h1>
				<p>Are you sure you really want to delete ALL user statistics data? <br>There is no way of undoing this action.</p>
				<p><a class="button" href="statistics.php?methode=truncate">Sure, delete statistics</a></p>
